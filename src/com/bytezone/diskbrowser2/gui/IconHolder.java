...
// -----------------------------------------------------------------------------------//
{
  ...
  static String[] diskIcons = { "5floppy-unmount-icon.png", "disk-icon.png",
      "disk-save-yellow-icon.png", "disk.png", "Floppy-Large-icon.png",
      "Floppy-blue-icon.png", "Floppy-brown-icon.png", "Floppy-green-icon.png",
      "Floppy-light-blue-icon.png", "Floppy-orange-icon.png", "Floppy-pink-icon.png",
      "Floppy-purple-icon.png", "Floppy-red-icon.png", "Floppy-yellow-icon.png",
      "Devices-media-floppy-icon.png" };
  ...
  // ---------------------------------------------------------------------------------//
  {
    ...
    folderArchiveZipIcon = new Image (
        getClass ().getResourceAsStream ("/resources/Folder-Archive-zip-icon.png"));
    harddiskIcon = new Image (
        getClass ().getResourceAsStream ("/resources/Devices-drive-harddisk-icon.png"));

    for (int i = 0, j = 65; i < 26; i++, j++)
    {
      fileIconImages[0][i] = new Image (getClass ().getResourceAsStream (
          String.format ("/resources/Letter-%s-lg-icon.png", (char) (j))));
      fileIconImages[1][i] = new Image (getClass ().getResourceAsStream (
          String.format ("/resources/Letter-%s-blue-icon.png", (char) (j))));
      fileIconImages[2][i] = new Image (getClass ().getResourceAsStream (
          String.format ("/resources/Letter-%s-pink-icon.png", (char) (j))));
      fileIconImages[3][i] = new Image (getClass ().getResourceAsStream (
          String.format ("/resources/Letter-%s-black-icon.png", (char) (j))));
    }
  }

  // ---------------------------------------------------------------------------------//
  Image getFolderIconImage (AppleTreeNode fileItem)
  // ---------------------------------------------------------------------------------//
  {
